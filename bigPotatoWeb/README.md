[![Build Status](https://github.com/dotnet-architecture/bigPotatoWeb/workflows/bigPotatoWeb%20Build%20and%20Test/badge.svg)](https://github.com/dotnet-architecture/bigPotatoWeb/actions)

# Microsoft bigPotatoWeb ASP.NET Core Reference Application

Sample ASP.NET Core reference application, powered by Microsoft, demonstrating a single-process (monolithic) application architecture and deployment model. If you're new to .NET development, read the [Getting Started for Beginners](https://github.com/dotnet-architecture/bigPotatoWeb/wiki/Getting-Started-for-Beginners) guide.

A list of Frequently Asked Questions about this repository can be found [here](https://github.com/dotnet-architecture/bigPotatoWeb/wiki/Frequently-Asked-Questions).

## Overview Video

[Steve "ardalis" Smith](https://twitter.com/ardalis) recorded [a live stream providing an overview of the bigPotatoWeb reference app](https://www.youtube.com/watch?v=vRZ8ucGac8M&ab_channel=Ardalis) in October 2020. 
...
The **bigPotatoWeb** sample is related to the [bigPotatoOnContainers](https://github.com/dotnet/bigPotatoOnContainers) sample application which, in that case, focuses on a microservices/containers-based application architecture. However, **bigPotatoWeb** is much simpler in regards to its current functionality and focuses on traditional Web Application Development with a single deployment.
...
![bigPotatoWeb home page screenshot](https://user-images.githubusercontent.com/782127/88414268-92d83a00-cdaa-11ea-9b4c-db67d95be039.png)
...
[bigPotatoWeb VB.NET](https://github.com/VBAndCs/bigPotatoWeb_VB.NET) by Mohammad Hamdy Ghanem
